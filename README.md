...
Supports upto 50 instances of book info storage; increase it by changing the array size for the library structure, i.e. change the `50` in each line with `libr lib[50];` to whatever number you wish.
